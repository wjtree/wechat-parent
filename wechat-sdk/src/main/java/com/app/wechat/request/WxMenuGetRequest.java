...
import com.app.wechat.response.WxMenuGetResponse;

/**
 * <p>功 能：自定义菜单查询接口API的请求信息</p>
 ...
 * @version 1.0
 */
public class WxMenuGetRequest extends AbstractWxRequest<WxMenuGetResponse> {
    private static final long serialVersionUID = 1L;

    public Class<WxMenuGetResponse> getResponseClass() {
        return WxMenuGetResponse.class;
    }

    public String getUrl(String accessToken) {
        return String.format(WxUrl.API_MENU_GET, accessToken);
    }

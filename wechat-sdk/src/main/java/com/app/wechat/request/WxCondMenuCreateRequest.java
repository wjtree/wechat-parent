...
import com.app.wechat.response.WxCondMenuCreateResponse;

/**
 * <p>功 能：创建个性化菜单API的请求信息</p>
 ...
 * @version 1.0
 */
public class WxCondMenuCreateRequest extends AbstractWxRequest<WxCondMenuCreateResponse> {
    private static final long serialVersionUID = 1L;

    private WxCondMenuModel object;

    public WxCondMenuCreateRequest(WxCondMenuModel object) {
        this.object = object;
    }

    public WxCondMenuModel getObject() {
        return object;
    }

    public Class<WxCondMenuCreateResponse> getResponseClass() {
        return WxCondMenuCreateResponse.class;
    }

    public String getUrl(String accessToken) {
        return String.format(WxUrl.API_MENU_ADDCONDITIONAL, accessToken);
    }

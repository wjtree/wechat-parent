...
import com.app.wechat.response.WxMenuCreateResponse;

/**
 * <p>功 能：自定义菜单创建接口API的请求信息</p>
 ...
 * @version 1.0
 */
public class WxMenuCreateRequest extends AbstractWxRequest<WxMenuCreateResponse> {
    private static final long serialVersionUID = 1L;

    private WxMenuModel object;

    public WxMenuCreateRequest(WxMenuModel object) {
        this.object = object;
    }
    ...
    public String getUrl(String accessToken) {
        return String.format(WxUrl.API_MENU_CREATE, accessToken);
    }
